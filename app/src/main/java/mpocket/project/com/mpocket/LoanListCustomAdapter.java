 ...
 */
public class LoanListCustomAdapter extends ArrayAdapter<LoanData> {

    public LoanListCustomAdapter(Context context, List<LoanData> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LoanData data = getItem(position);
        ...
        personName.setText(data.get_lend_from());
